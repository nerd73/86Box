...
extern int machine_at_j403tg_init(const machine_t *);
extern int machine_at_pb450_isa_init(const machine_t *);
extern int machine_at_pb450_pci_init(const machine_t *);
